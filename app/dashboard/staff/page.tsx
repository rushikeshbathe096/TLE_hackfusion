    ...
    return (
        <div className="relative min-h-[calc(100vh-4rem)]">
            <div className={`fixed inset-0 z-0 pointer-events-none ${isLight ? 'opacity-20' : 'opacity-100'}`}>
                ...
                <Galaxy
                    starSpeed={0.5}
                    density={0.8} // Reduced density for "sharpness" reduction
                    hueShift={isLight ? 200 : 140}
                    speed={1}
                    glowIntensity={isLight ? 0.03 : 0.2} // Slightly reduced glow
                    saturation={0}
                    mouseRepulsion
                    repulsionStrength={2}
            ...
            <div className="relative z-10 space-y-8 animate-in fade-in duration-500 p-1">
                ...
                <div className="bg-card/80 backdrop-blur-sm text-card-foreground border border-border rounded-xl p-6 shadow-sm">

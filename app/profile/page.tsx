...
export default function ProfilePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setTimeout(() => {
                if (user.role === 'authority') router.push('/dashboard/authority');
                                ...
                                <div className="space-y-4 pt-4 border-t">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div
                                            ...
                                            className="cursor-pointer border-2 border-dashed border-muted rounded-lg p-6 hover:bg-muted/50 transition-colors flex flex-col items-center justify-center w-full text-muted-foreground"
                                        >
                                            {formData.govtIdUrl ? (
                                                <div className="text-center">
                                                    ...
                                                    <p className="text-xs mt-2">Click to change</p>
                                                </div>
                                            ) : (
                                                <>
